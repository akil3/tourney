...
export default function TeamsPage() {
  const params = useParams(); const tournamentId = params.id as string; const { isAuthenticated } = useRole();
  const [teams, setTeams] = useState<Team[]>([]); const [newTeamName, setNewTeamName] = useState(""); const [loading, setLoading] = useState(true); const [expandedTeam, setExpandedTeam] = useState<string | null>(null); const [newPlayerName, setNewPlayerName] = useState("");
